...
function createClient(params) {
  ...
  "".concat(sdkMain, "/").concat("7.18.0"), params.application, params.integration, params.feature);
...
function createEnvironmentApi(makeRequest) {
  ...
  return {
     ...
     * ```
     */
    getEntryReferences: function getEntryReferences(entryId, maxDepth) {
      var raw = this.toPlainObject();
      return makeRequest({
        entityType: 'Entry',
        action: 'references',
...
function createEntryApi(makeRequest) {
  ...
  return {
    ...
    references: function references(maxDepth) {
      var raw = this.toPlainObject();
      return makeRequest({
        entityType: 'Entry',
        action: 'references',
